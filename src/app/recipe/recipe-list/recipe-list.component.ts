...
export class RecipeListComponent implements OnInit{
  ...
  displayedColumns: string[] = ['id', 'name','descr','instr.','List of ingred.','createdOn','updaedOn','star'];
              ...
              .subscribe(
                _datas => {
                  if(_datas) {
                    ...
                    this.recipes = _datas;                    
                    console.log(" getRecipes() this.recipes.length = " + this.recipes.length);
                    console.log("ngOnInit this.recipes[0].ingredients?.length = " + this.recipes[0].ingredients?.length);
                    console.log("ngOnInit this.recipes[0].ingredients = " + this.recipes[0].ingredients);
                    this.flags = true;
                  } else {
  ...
  ngOnInit(): void {
    this.getRecipes();    
    console.log("ngOnInit this.recipes.length = " + this.recipes.length);
  }  
